...
\begin{abstract}
Board-free extrinsic calibration of \textbf{roadside} LiDARs---using a flying UAV hull
as target, with no onboard LiDAR---is governed not by sensor noise but by
\emph{flight attitude diversity}.
...
while active 3D attitude excitation restores identifiability and centimeter-level
