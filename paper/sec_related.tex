...
estimation from per-sensor Stage-2 extrinsic refinement, avoiding cross-sensor Ceres
block coupling that can leak state between LiDAR solves.
...
multi-LiDAR layouts \cite{TODO_v2x_multilidar}.
...
which joint lever-arm optimization cannot remove.
