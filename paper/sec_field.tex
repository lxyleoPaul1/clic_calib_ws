...
\begin{table*}[!t]
  ...
  (placeholder; simulation reference is $\approx$0.25$\times$ under a coherent-bias
  assumption).}
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.42\textwidth}cc@{}}
    ...
    Metric & Sim. & Field \\
    \midrule
    rel/abs trace ratio & 0.247$\pm$0.12$\times$ & \TODO{campaign D: rel/abs ratio} \\
...
\begin{enumerate}
  ...
  \item \textbf{Coherent-bias residual:} is field rel/abs attenuation weaker than
    the simulation $\approx$0.25$\times$ ratio?
