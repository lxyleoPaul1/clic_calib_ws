/*
 * PRESERVED from clic estimator/factor/analytic_diff/trajectory_value_factor.h (§5).
 * IMU / preintegration factors (IMUFactor, PreIntegrationFactor, ...) are NOT used
 * in clic_calib — see legacy_clic/imu_preintegration/. RTK uses rtk_position_factor.h (§4.2).
 * IMUPoseFactor / spline evaluation patterns remain as reference for Phase 1.
 * NOT linked in CMake until IMU includes are removed.
 */
/*
...
#include <clic_calib/factor/split_spline_view.h>
