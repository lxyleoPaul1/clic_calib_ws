...
EST_SRCS=(
  ...
  "${ROOT}/src/clic_calib/estimator/observed_mean_gate.cpp"
  "${ROOT}/src/clic_calib/estimator/body_gated_calibration.cpp"
  "${ROOT}/src/clic_calib/estimator/multi_lidar_body_calibration.cpp"
  "${ROOT}/src/clic_calib/estimator/relative_extrinsic.cpp"
